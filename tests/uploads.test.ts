import fs from 'fs';
import type { ResponseLike } from 'petstore-teest/internal/to-file';
import { toFile } from 'petstore-teest/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('petstore-teest/core/uploads');
    await expect(
